...
function register_downloads_post_type() {
  ...
  $labels = array(
    ...
    'name_admin_bar'        => __( 'Downloads Post Type', 'text_domain' ),
    'archives'              => __( 'Downloads Archives', 'text_domain' ),
    'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
    'all_items'             => __( 'All Downloads', 'text_domain' ),
    'add_new_item'          => __( 'Add New Downloads', 'text_domain' ),
  ...
  register_post_type( 'millie_downloads', $args );

}
add_action( 'init', 'register_downloads_post_type', 0 );
