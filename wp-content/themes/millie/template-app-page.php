...
<section id="content" role="main" class="container content-container">
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <section class="entry-content cf">
            <video class="video-js vjs-default-skin vjs-big-play-centered vjs-4-3" controls preload="auto" width="720" height="540" poster="http://milliemarotta.co.uk/wp-content/uploads/2017/06/mmca-poster.jpg" data-setup={}>
